...
# Based on: Barzilai, J.M. Borwein, Two point step size gradient methods, IMA J. Numer. Anal. 8 (1988) 141-148. http://dx.doi.org/10.1093/imanum/8.1.141.

class FlpDualLSBBSVM(object):

    def __init__(self, lambd=1, max_iter=50, kernel="linear", degree=None) -> None:
        super().__init__()
        self.degree = degree
        self.lambd = lambd
    ...
    def fit(self, X, y):
        ...
        b_i = np.random.random(size=(self.data.shape[0] + 1, 1))
        b_i_minus1 = p_i = 0
